...
class ImageutilityModule : public titanium::Proxy
{
public:
	explicit ImageutilityModule(jobject javaObject);
...
private:
	// Methods -----------------------------------------------------------
	static v8::Handle<v8::Value> rotateResizeImage(const v8::Arguments&);
